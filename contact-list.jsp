                ...
                <table class="table table-bordered">
                  <thead>                  
                    <tr>
                      ...
                      <th class="text-center">myMessage</th>
                      <th class="text-center">IsSeen</th>
                  ...
                  <tbody id="sort-list">
                   <c:forEach var="contact" items="${contactList}">
                    <tr>
                      ...
                      <td> ${contact.email}</td> 
                      <td> ${contact.myMessage}</td>     
                      <td>
	               		<c:if test="${!contact.isSeen}">
	                      	<a  href="contact-seen?id=${contact.id}" class="btn btn-block btn-primary">Mark as Seen</a>
	                     </c:if>
