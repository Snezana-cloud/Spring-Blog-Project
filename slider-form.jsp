  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Blog Slider Form</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               <li class="breadcrumb-item"><a href="http://localhost:8080/Domaci/">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Blog Slider</a></li>
              <li class="breadcrumb-item active">Blog Slider Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
              ...
              <form:form role="form" action="slider-save" modelAttribute="slider">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Link</label>
                    <form:input path="link" type="text" class="form-control" placeholder="Enter link"/>                   
                  </div> 
                  <div class="form-group">
                    <label>Image</label>
                  ...
                  <div class="form-group">
                    ...
                    <form:input path="linkTekst" type="text" class="form-control" placeholder="Enter link tekst"/>                   
                  </div> 
                <div class="form-group">
                    <label>OrderOfImage</label>
                    <form:input path="orderOfImage" type="text" class="form-control" placeholder="Enter letter from A .."/>                   
                  </div> 
 			
      	              <div class="custom-control custom-checkbox">
                          <form:checkbox id="customCheckbox1" class="custom-control-input"  path="isOnFrontPage"/>
                          <label for="customCheckbox1" class="custom-control-label">IsOnFrontPage</label>
                      </div>  
