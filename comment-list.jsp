                ...
                <table class="table table-bordered">
                  <thead>                  
                    <tr>
                      ...
                      <th style="width: 20%;" class="text-center">Commenter's Name</th>
                      <th style="width: 20%;" class="text-center">Commenter's Email</th>
                    
                      <th style="width: 30%;" class="text-center">Comment</th>
                      <th class="text-center">Created At</th>
                                     
                      <th class="text-center">Refers Of Blog</th>
                       	 ...
                       	 <c:when test="${isAdmin}">
                       	   <c:forEach var="comment" items="${commentList}">              
			                    <tr>
			                     ...
			                     <td><fmt:formatDate value="${comment.date}" pattern="MMMM | yyyy"/></td>
								
								 <td> ${comment.blog.id} </td>
			                       <td class="text-center">	
			                         <a href="comment-enable?id=${comment.id}" class="btn btn-info" >
							            <c:if test="${!comment.enabled}">
							                <i class="fas fa-ban"  style="color:#ffff00;"></i>
							            </c:if >
							            <c:if test="${comment.enabled}">
							                <i class="fas fa-check" style="color:#80ff00;"></i>
							            </c:if>
							          </a> 
			                      </td>
			                    </tr>
