        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Blog Categories Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-6">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Blog Categories Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form:form role="form" action="category-save" modelAttribute="category">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <form:input path="description" type="text" id="description" class="form-control" placeholder="Enter desription"/>                   
                  </div> 
                 <div class="form-group">
                    <label for="orderCategory">OrderOfCategory</label>
                    <form:input path="orderCategory" type="number" id="order" class="form-control" placeholder="Enter number" required="true"/>                                    
                  </div> 
                  
      	              <div class="custom-control custom-checkbox">
                          <form:checkbox id="customCheckbox1" class="custom-control-input"  path="isOnFrontPage"/>
                          <label for="customCheckbox1" class="custom-control-label">IsOnMainPage</label>
                      </div>        
                 </div>
                <!-- /.card-body -->
