        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="user-edit-profile" class="dropdown-item">   <!-- nisam pisala ?id=... vec sam korisitla principle obj -->
            ...
            <div class="media align-items-center">
              <img src="${pageContext.request.contextPath}/img/${user.image}" alt="User Avatar" class="img-brand-50 mr-3 img-circle">
                ...
                <table class="table table-bordered">
                  ...
                  <c:forEach var="user" items="${userList}">
                    <tr>
                      ...
                      <td> ${user.name}</td>
                      <td class="text-center">
                          <img src="${pageContext.request.contextPath}/img/${user.image}" style="max-width: 100px; max-height:80px;">
                      </td>
                      <td> ${user.email}</td>
	                         ...
	                         <a href="user-enable?username=${user.username}" class="btn btn-info">
	                           <c:if test="${user.enabled}">
	                             <i class="fas fa-user-check"></i>
	                              ...
	                              <c:if test="${!user.enabled}">
	                             <i class="fas fa-user-slash" style="color:#66ffff;"></i>
	                           </c:if> 
	                         </a> 
