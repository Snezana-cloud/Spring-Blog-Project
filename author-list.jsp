            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  ...
                  <a href="author-form" class="btn btn-success">
                ...
                <table class="table table-bordered">
                  <thead>                  
                    <tr>
                      ...
                      <th style="width: 30%;">Author's Photo</th>
                  ...
                  <c:forEach var="author" items="${authorList}">
                    <tr>
					  ...
					  <td>  <img src="${author.image}" style="max-width: 80px; max-height: 80px;"> </td>		  
                      <td class="text-center">
                        <div class="btn-group">
                          <a href="author-update?id=${author.id}" class="btn btn-info">
                            <i class="fas fa-edit"></i>
                          </a>                     
                          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#delete-modal-${author.id}">
				      ...
				      <div class="modal-dialog">
				        <div class="modal-content">
				          ...
				          <div class="modal-footer justify-content-between"> 
				            ...
				            <a href="author-delete?id=${author.id}" class="btn btn-danger">Delete</a>
