    ...
    <div class="container">
      <div class="row">
        ...
        <main class="posts-listing col-lg-8"> 
          <div class="container">
            <h2 class="mb-3">Tag "${selectedTag.name}"</h2>
            <div class="row">
              ...
              <c:forEach var="blog" items="${blogList}">
	              <div class="post col-xl-6">
	                <div class="post-thumbnail">
	                   <a href="blog-post?id=${blog.id}"><img src="${blog.imageBlog}" alt="picture" class="img-fluid" style="height: 200px; width: 400px"></a>
	                 </div>
	                <div class="post-details">
	                  <div class="post-meta d-flex justify-content-between">
	                    <div class="date meta-last">${blog.formattedDateForDisplay}</div>
	                    <div class="category">
	                  ...
	                  <footer class="post-footer d-flex align-items-center">
	                    <a href="blog-author?id=${blog.author.id}" class="author d-flex align-items-center flex-wrap">
	                      <div class="avatar"><img src="${blog.author.image}" alt="picture" class="img-fluid"></div>
	                      <div class="title"><span>${blog.author.name}</span></div>
	                    </a>
	                    <div class="date"><i class="icon-clock"></i> ${blog.formattedDate}</div>
	                    <div class="comments meta-last"><i class="icon-comment"></i>${blog.count}</div>
	                  </footer>
                    </div>
	              </div>
	            </c:forEach>
