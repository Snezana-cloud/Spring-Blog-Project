    ...
    <div class="container">
      <div class="row">
        ...
        <main class="posts-listing col-lg-8"> 
          <div class="container">
            <h2 class="mb-3">Category "${selectedCategory.name}"</h2>
            ...
            <!-- Pagination -->
	       	<nav aria-label="Page navigation example">
			    <ul class="pagination d-flex justify-content-center">
			        <!-- Previous Page Link -->
			        <c:if test="${page > 1}">
			            <c:url value="/blog-category" var="prev">
			        ...
			        <c:forEach var="i" begin="1" end="${maxPages}">
			            <c:choose>
			                ...
			                <c:otherwise>
			                    <c:url value="/blog-category" var="url">
			        ...
			        <c:if test="${page < maxPages}">
			            <c:url value="/blog-category" var="next">
			                <c:param name="page" value="${page + 1}"/>
			            </c:url>
			            <li class="page-item">
        ...
        <aside class="col-lg-4">
          ...
          <div class="widget search">
            ...
            <form:form action="blog-search" class="search-form">
              <div class="form-group">
