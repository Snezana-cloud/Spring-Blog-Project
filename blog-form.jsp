              ...
              <form:form role="form" action="blog-save" modelAttribute="blog">                      
                <div class="card-body">
                       ...
                       <div class="form-group">
                        ...
                        <form:input path="imageBlog" type="text" class="form-control" placeholder="Enter picture"/>
                        <form:errors path="imageBlog" cssClass="text-danger"/>                    
                      </div>
                      <div class="form-group">
                        <label>Title</label>
                      ...
                      <div class="form-group">
                        ...
                        <form:textarea path="content1" class="form-control" placeholder="Enter Content"/>
                        <form:errors path="content1" cssClass="text-danger"/>                    
                      </div>
                      <div class="form-group">
                        <label>Content2</label>
                        <form:textarea path="content2" class="form-control" placeholder="Enter Content"/>
                        <form:errors path="content2" cssClass="text-danger"/>                    
                      </div>
                      
                      <div class="form-group">
                        <label>Words From Famous Person</label>
                        <form:textarea path="famousWords" class="form-control" placeholder="Enter Content"/>
                        <form:errors path="famousWords" cssClass="text-danger"/>                    
                      </div>
                      
                      <div class="form-group">
                        <label>Name Of Famous Person</label>
                        <form:textarea path="famousPerson" class="form-control" placeholder="Enter Content"/>
                        <form:errors path="famousPerson" cssClass="text-danger"/>                    
                      </div>
                      ...
                      <div class="form-group">
                        <label>Tag</label>
                         <form:select path="tag" items="${tagList}" itemLabel="name" itemValue="id" multiple="true" class="form-control" />                    
                      </div>                 
           
                       <div class="form-group">
                        <label>Author</label>
                        <form:select class="form-control" path="author.id" itemLabel="name" itemValue="id"  items="${authorList}"  />
                      </div>
                      
                   
                      
                      <div class="form-group">
                        <label>Second Blog's Photo</label>
                        <form:input path="imageFollowing" type="text" class="form-control"/>
                        <form:errors path="imageFollowing" cssClass="text-danger"/>
                      </div> 
